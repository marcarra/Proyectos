 ...
 * @returns {boolean} Verdadero si la cadena es válida, falso de lo contrario.
 */
 ...
 * @returns {boolean} Verdadero si el número es válido, falso de lo contrario.
 */
 ...
 * @param {string} email - Cadena a verificar.
 * @returns {boolean} Verdadero si la cadena es un correo electrónico válido, falso de lo contrario.
 */
